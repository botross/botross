...
<!-- HEADER WAVE -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Botros%20Aziz&fontSize=60&fontColor=ffffff&fontAlignY=38&desc=Full-Stack%20Developer&descSize=20&descAlignY=58&descColor=a78bfa&animation=fadeIn" />

<!-- TYPING SVG -->
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=1000&color=A78BFA&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=80&lines=Turning+ideas+into+elegant+code+✦;Building+the+web%2C+one+component+at+a+time+⚡;Next.js+%7C+React+%7C+Node.js+%7C+MongoDB+🔥" alt="Typing SVG" />
...
const botros = {
  ...
  location: "Egypt 🇪🇬",
  passion:  "Crafting experiences that matter",

  stack: {
    frontend: ["Next.js", "React", "Bootstrap"],
    backend:  ["Node.js", "Express"],
    database: ["MongoDB"],
    tools:    ["Git", "Vercel", "Sanity CMS"],
  },

  currentlyBuilding: "Something the world hasn't seen yet 🚀",
  alwaysLearning:    true,
  openToWork:        true,
};
```
...
&nbsp;
<a href="https://wa.me/201228449798" target="_blank">
  <img src="https://img.shields.io/badge/WhatsApp-25D366.svg?style=for-the-badge&logo=whatsapp&logoColor=white" />
</a>

<br/><br/>

> *"Code is poetry written for machines, but felt by humans."*
